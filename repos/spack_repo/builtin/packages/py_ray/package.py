...
class PyRay(PythonPackage):
    ...
    depends_on("bazel@6.5.0", when="@2.53.0", type="build")
    ...
    depends_on("py-numpy@1.20:", when="@2.53.0:", type=("build", "run"))
    depends_on("py-numpy@1.16:", when="@2.0.1", type=("build", "run"))
    ...
    with when("+default"):
        ...
        depends_on("py-py-spy@0.2:", when="@2.53.0: ^python@:3.11", type=("build", "run"))
        depends_on("py-py-spy@0.2:", when="@2.0.1", type=("build", "run"))
        depends_on("py-grpcio@1.42.0:", when="@2.53.0: ^python@3.10:", type=("build", "run"))
