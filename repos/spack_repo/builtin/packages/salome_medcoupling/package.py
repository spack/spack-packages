...
class SalomeMedcoupling(CMakePackage):
    ...
    version(
        "9.10.0", tag="V9_10_0", commit="fe2e38d301902c626f644907e00e499552bb2fa5", deprecated=True
    )
    version(
        "9.9.0", tag="V9_9_0", commit="5b2a9cc1cc18fffd5674a589aacf368008983b45", deprecated=True
    )
    version(
        "9.8.0", tag="V9_8_0", commit="8a82259c9a9228c54efeddd52d4afe6c0e397c30", deprecated=True
    )
    version(
        "9.7.0", tag="V9_7_0", commit="773434a7f2a5cbacc2f50e93ea6d6a48a157acd9", deprecated=True
    )
    version(
        "9.6.0", tag="V9_6_0", commit="2c14a65b40252770b3503945405f5bdb2f29f8e2", deprecated=True
    )
    version(
        "9.5.0", tag="V9_5_0", commit="dd75474d950baf8ff862b03cb1685f2a2d562846", deprecated=True
    )
    version(
        "9.4.0", tag="V9_4_0", commit="984fe46c4076f08f42ef43e290e3cd1aea5a8182", deprecated=True
    )
    version(
        "9.3.0", tag="V9_3_0", commit="32521cd6e5c113de5db7953a80149e5ab492120a", deprecated=True
    )
