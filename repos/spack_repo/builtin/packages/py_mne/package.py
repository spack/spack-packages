...
class PyMne(PythonPackage):
    ...
    depends_on("py-matplotlib@3.8:", when="@1.11:", type=("build", "run"))
    ...
    depends_on("py-numpy@1.26:2", when="@1.11:", type=("build", "run"))
    depends_on("py-numpy@1.25:2", when="@1.6.1:1.10", type=("build", "run"))
