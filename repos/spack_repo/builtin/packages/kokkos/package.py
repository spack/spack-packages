...
class Kokkos(CMakePackage, CudaPackage, ROCmPackage):
    ...
    options_variants = {
        ...
        "cuda_lambda": [True, "@:4 +cuda", "Activate experimental lambda features"],
        ...
        "cuda_uvm": [True, "@:4 +cuda", "Enable unified virtual memory (UVM) for CUDA"],
        ...
        "debug_dualview_modify_check": [True, "@:4", "Debug check on dual views"],
