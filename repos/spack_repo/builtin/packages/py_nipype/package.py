...
class PyNipype(PythonPackage):
    ...
    depends_on("py-networkx@2.5:", when="@1.9.1:", type=("build", "run"))
    depends_on("py-networkx@2:", when="@1.6:", type=("build", "run"))
    depends_on("py-networkx@1.9:", type=("build", "run"))
    depends_on("py-nibabel@3:", when="@1.9.1:", type=("build", "run"))
    depends_on("py-nibabel@2.1:", type=("build", "run"))
    depends_on("py-numpy@1.21:", when="@1.9.1:", type=("build", "run"))
    ...
    depends_on("py-scipy@1.8:", when="@1.9.1:", type=("build", "run"))
    depends_on("py-scipy@0.14:", type=("build", "run"))
    depends_on("py-simplejson@3.8:", type=("build", "run"))
    depends_on("py-traits@6.2:", when="@1.9.1:", type=("build", "run"))
    ...
    depends_on("py-acres", when="@1.9.1:", type=("build", "run"))
    depends_on("py-etelemetry@0.3.1:", when="@1.9.1:", type=("build", "run"))
    ...
    depends_on("py-puremagic", when="@1.9:", type=("build", "run"))
