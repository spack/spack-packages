...
class PyNibabel(PythonPackage):
    ...
    depends_on("py-numpy@1.22:", when="@5.3:", type=("build", "run"))
    ...
    depends_on("py-packaging@20:", when="@5.3:", type=("build", "run"))
    depends_on("py-packaging@17:", when="@4:", type=("build", "run"))
    depends_on("py-packaging@14.3:", when="@3.1:", type=("build", "run"))
    depends_on("py-importlib-resources@5.12:", when="@5.3: ^python@:3.11", type=("build", "run"))
    ...
    depends_on("py-typing-extensions@4.6:", when="@5.3: ^python@:3.12", type=("build", "run"))
