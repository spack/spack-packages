...
class Ecbuild(CMakePackage):
    ...
    version(
        "3.12.0",
        sha256="70c7fc9b17f736a3312167c2c36d13b3b5833a255fe2b168b2886ad7c743ffdf",
    )
    version(
        "3.11.0",
        sha256="38a96bdeb38feb65446b6f95b35492232abd188c41b8a28fd128f9f88e00b05d",
    )
    version(
        "3.10.0",
        sha256="7065e1725584b507517cbfc456299ff588e20adf37bc6210ce89fb65a1ad08d0",
    )
    version(
        "3.9.1",
        sha256="48c2dbd342865049cc39afd7fe886fce9ce162105ca72b8aef9a09c21d9655ba",
    )
    version(
        "3.9.0",
    ...
    version(
        "3.8.5",
        sha256="aa0c44cab0fffec4c0b3542e91ebcc736b3d41b68a068d30c023ec0df5f93425",
    )
    version(
        "3.7.2",
    ...
    def patch(self):
        ...
        filter_file(
            "https?://.*test-data",
            "DISABLED_BY_DEFAULT",
            "cmake/ecbuild_check_urls.cmake",
        )
        filter_file(
            "https?://.*test-data",
            "DISABLED_BY_DEFAULT",
