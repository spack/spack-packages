...
class PyLanggraph(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-langchain-core@1.4:1",)
        depends_on("py-langgraph-checkpoint@4.1:4")
        depends_on("py-langgraph-prebuilt@1.1")
        depends_on("py-xxhash@3.5:")
        depends_on("py-pydantic@2.7.4:")
