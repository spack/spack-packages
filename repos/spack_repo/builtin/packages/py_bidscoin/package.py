...
class PyBidscoin(PythonPackage):
    ...
    version("4.6.2", sha256="91c1a48af0ab91953adfc248fc08165925b261d337a96ef4f8fbbeb0b00bdebe")
    ...
    depends_on("python@3.9:", when="@4.5:", type=("build", "run"))
    ...
    depends_on("py-pyyaml", when="@4.5:", type=("build", "run"))
    depends_on("py-tomli@1.1:", when="@4.1: ^python@:3.10", type=("build", "run"))
    depends_on("py-rich", when="@4.6.2:", type=("build", "run"))
    ...
    depends_on("py-jsonschema", when="@4.3:", type=("build", "run"))
    depends_on("py-bidsschematools", when="@4.4:", type=("build", "run"))
    depends_on("py-drmaa", when="@4.3:", type=("build", "run"))
    depends_on("py-duecredit", when="@4.3:", type=("build", "run"))

    depends_on("dcm2niix", type=("build", "run"))

    # Historical dependencies
    depends_on("py-coloredlogs", when="@:4.6.1", type=("build", "run"))
    depends_on("py-tqdm@4.60:", when="@4:4.6.1", type=("build", "run"))
    depends_on("py-tqdm", when="@:4.6.1", type=("build", "run"))
    depends_on("py-ruamel-yaml@0.15.35:", when="@:4.4", type=("build", "run"))
