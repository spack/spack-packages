...
class PyPytorchLightning(PythonPackage):
    ...
    version("2.1.4", sha256="f685f2a4862f951b2dbe47ba91945406ffca6be4c8e967b870e86e3b04b15649")
    version("2.0.9", sha256="a4cbfe5256192b315c76f864d3f9d60bd04aace361950e83326b29565b212387")
    ...
    depends_on("py-numpy@1.17.2:", when="@1.3:2.3", type=("build", "run"))
    depends_on("py-numpy@1.16.6:", when="@:1.2", type=("build", "run"))
    depends_on("py-torch@2.1:", when="@2.4:", type=("build", "run"))
    depends_on("py-torch@2.1:", when="@2.4:", type=("build", "run"))
    depends_on("py-torch@2.0:", when="@2.3:", type=("build", "run"))
    depends_on("py-torch@1.13:", when="@2.2:", type=("build", "run"))
    depends_on("py-torch@1.12:", when="@2.1:", type=("build", "run"))
    ...
    depends_on("py-pyyaml@5.4.1:", when="@1.6:", type=("build", "run"))
    ...
    depends_on("py-fsspec +http", type=("build", "run"))
    depends_on("py-fsspec@2022.5:", when="@2.1:", type=("build", "run"))
    depends_on("py-fsspec@2021.6.1:", when="@1.8:", type=("build", "run"))
    depends_on("py-fsspec@2021.5.0:2021.05,2021.06.1:", when="@1.3:", type=("build", "run"))
    depends_on("py-fsspec@0.8.1:", when="@:1.2", type=("build", "run"))
    ...
    depends_on("py-packaging@20:", when="@2.1:", type=("build", "run"))
    ...
    depends_on("py-typing-extensions@4.5.1:", when="@2.5:", type=("build", "run"))
    depends_on("py-typing-extensions@4.4.0:", when="@2.2:", type=("build", "run"))
    depends_on("py-typing-extensions@4.0.0:", when="@1.6:", type=("build", "run"))
    depends_on("py-typing-extensions", when="@1.4:1.5", type=("build", "run"))
    depends_on("py-lightning-utilities@0.10:", when="@2.3:", type=("build", "run"))
    depends_on("py-lightning-utilities@0.8:", when="@2.1:", type=("build", "run"))
