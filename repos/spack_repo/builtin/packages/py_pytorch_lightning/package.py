...
class PyPytorchLightning(PythonPackage):
    ...
    pypi = "pytorch-lightning/pytorch_lightning-2.6.1.tar.gz"

    maintainers("adamjstewart")

    license("Apache-2.0")

    version("2.6.6", sha256="52c52b20522dd3d3feb3bb3aae2dbe3f291e8e836d4111a74cfd72e9df018834")
    with default_args(deprecated=True):
        ...
        # https://www.cvedetails.com/cve/CVE-2021-4118/
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-torch@2.1:", when="@2.6:")
        depends_on("py-torch@1.11:", when="@2:")
        depends_on("py-torch@1.10:", when="@1.9:")
        depends_on("py-torch@1.9:", when="@1.7:")
        depends_on("py-torch@1.8:", when="@1.6:")
        depends_on("py-torch@1.6:", when="@1.4:")
        depends_on("py-torch@1.4:")
        depends_on("py-tqdm@4.57:", when="@1.6.3:")
        depends_on("py-tqdm@4.41:")
        depends_on("py-pyyaml@5.4.1:", when="@2.6:")
        depends_on("py-pyyaml@5.4:", when="@1.6:")
        depends_on("py-pyyaml@5.1:", when="@1.4:")
        depends_on("py-pyyaml@5.1:5.4.1", when="@1.3")
        depends_on("py-pyyaml@5.1:5.3,5.5:", when="@:1.2")
        depends_on("py-fsspec+http")
        depends_on("py-fsspec@2022.5:", when="@2.6:")
        depends_on("py-fsspec@2021.06.1:", when="@1.8:")
        depends_on("py-fsspec@2021.05.0:2021.05,2021.06.1:", when="@1.3:")
        depends_on("py-fsspec@0.8.1:")
        depends_on("py-torchmetrics@0.7.1:", when="@2.6:")
        depends_on("py-torchmetrics@0.7:", when="@1.7:")
        depends_on("py-torchmetrics@0.4.1:", when="@1.5:")
        depends_on("py-torchmetrics@0.4.0:", when="@1.4")
        depends_on("py-torchmetrics@0.2.0:", when="@1.3")
        depends_on("py-torchmetrics@0.2.0", when="@:1.2")
        depends_on("py-packaging@23:", when="@2.6:")
        depends_on("py-packaging@17.1:", when="@1.9:")
        depends_on("py-packaging@17.0:", when="@1.3:")
        depends_on("py-packaging", when="@:1.2")
        depends_on("py-typing-extensions@4.5.1:", when="@2.6:")
        depends_on("py-typing-extensions@4.0.0:", when="@1.6:")
        depends_on("py-typing-extensions", when="@1.4:1.5")
        depends_on("py-lightning-utilities@0.10:", when="@2.6:")
        depends_on("py-lightning-utilities@0.7:", when="@2:")
        depends_on("py-lightning-utilities@0.6.0.post0:", when="@1.9.1:")
        depends_on("py-lightning-utilities@0.4.2:", when="@1.9.0")
        depends_on("py-lightning-utilities@0.3,0.4.1:", when="@1.8.4:1.8")
        depends_on("py-lightning-utilities@0.3:", when="@1.8.0:1.8.3")

        # Historical dependencies
        depends_on("py-lightning-lite@1.8.0", when="@1.8.0")
        depends_on("py-future@0.17.1:", when="@:1.5")
        depends_on("py-numpy@1.17.2:", when="@1.3:2.0")
        depends_on("py-numpy@1.16.6:", when="@:1.2")
        depends_on("pil@:8.2,8.3.1:", when="@1.3")
        depends_on("py-protobuf@:3.20.1", when="@1.6.4:1.6")
        depends_on("py-pydeprecate@0.3.1:", when="@1.6.4:1.7")
        depends_on("py-pydeprecate@0.3.1:0.3", when="@1.6:1.6.3")
        depends_on("py-pydeprecate@0.3.1", when="@1.4:1.5")
        depends_on("py-pydeprecate@0.3.0", when="@1.3")
        # https://github.com/Lightning-AI/pytorch-lightning/pull/20081
        depends_on("py-setuptools", when="@:2.3")
        depends_on("py-tensorboardx@2.2:", when="@1.8.3:1.8")
        depends_on("py-tensorboard@2.9.1:", when="@1.7:1.8.2")
        depends_on("py-tensorboard@2.2.0:", when="@1.5:1.6")
        depends_on("py-tensorboard@2.2.0:2.4,2.5.1:", when="@:1.4")
