...
class PyDataladNeuroimaging(PythonPackage):
    ...
    version("0.3.7", sha256="a13bfb10c60701d6551dec974e4460828f5c2167cd11c00c216136dc09341383")
    ...
    depends_on("python@3.9:", when="@0.3.6:", type=("build", "run"))

    depends_on("py-setuptools@59:", when="@0.3.7:", type="build")
    ...
    depends_on("py-pydicom@2:", when="@0.3.6:", type=("build", "run"))
