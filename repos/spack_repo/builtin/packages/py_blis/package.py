...
class PyBlis(PythonPackage):
    ...
    version("1.3.3", sha256="034d4560ff3cc43e8aa37e188451b0440e3261d989bb8a42ceee865607715ecd")
    ...
    depends_on("py-cython@3", when="@1.3.3:", type="build")
    depends_on("py-numpy@1.15:", when="@:0.9.1", type=("build", "run"))
    depends_on("py-numpy@2:", when="@1.3.3:", type=("build", "run"))
