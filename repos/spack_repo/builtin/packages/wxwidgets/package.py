...
class Wxwidgets(AutotoolsPackage):
    ...
    # Note: for odd minor versions API and ABI compatibility are not guaranteed; keep latest stable preferred
    version("3.3.3", sha256="81b09d6dd9f1ed9301f8c55a968a488d0491f264dc2bab19a7e407ac67009482")
    version("3.2.11", sha256="6a129015bce2e914e4bf61ec4411854ad962801d47e92f2eb8340adb6a90af08", preferred=True)
