...
class PyTerminado(PythonPackage):
    ...
    version("0.18.1", sha256="de09f2c4b85de4765f7714688fff57d3e75bad1f909b589fde880460c753fd2e")
    ...
    depends_on("python@3.8:", when="@0.18:", type=("build", "run"))
    depends_on("python@3.7:", when="@0.13:", type=("build", "run"))
