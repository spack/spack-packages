...
class Dbcsr(CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant("mpi_f08", default=True, when="@2.6: ^mpich@4.1:", description="Use mpi F08 module")
    variant("mpi_f08", default=True, when="@2.6: ^cray-mpich@9:", description="Use mpi F08 module")
