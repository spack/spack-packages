...
class Tioga(CMakePackage):
    ...
    # so work on TIOGA has continued in the Kynema project
    version("main", git="https://github.com/Kynema/tioga.git", branch="main")
    version(
        "1.3.0",
        git="https://github.com/Kynema/tioga.git",
        tag="v1.3.0",
