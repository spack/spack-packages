...
class PyColorcet(PythonPackage):
    ...
    version("3.1.0", sha256="2921b3cd81a2288aaf2d63dbc0ce3c26dcd882e8c389cc505d6886bf7aa9a4eb")
    ...
    depends_on("py-setuptools-scm@6:", type="build", when="@3.1:")

    depends_on("py-param@1.7.0:", type=("build", "run"), when="@3.0.0")
    depends_on("py-pyct@0.4.4:", type=("build", "run"), when="@3.0.0")
