...
class RPillar(RPackage):
    ...
    version("1.11.1", sha256="056ce154238c9b5b8d5dcbcb52e1bc51d33870ce08c8a9ca9496478bd59f4653")
    ...
    with default_args(type=("build", "run")):
        depends_on("r-cli@2.3.0:", when="@1.7.0:")
        depends_on("r-cli")
        depends_on("r-glue", when="@1.6.5:")
        depends_on("r-lifecycle", when="@1.4.7:")
        depends_on("r-rlang@1.0.2:", when="@1.8.1:")
        depends_on("r-rlang@0.3.0:")
        depends_on("r-utf8@1.1.0:")
        depends_on("r-vctrs@0.5.0:", when="@1.9.0:")
        depends_on("r-vctrs@0.3.8:", when="@1.6.1:")
        depends_on("r-vctrs@0.2.0:", when="@1.4.7:")
        depends_on("r-vctrs", when="@1.4.0:")
