...
class PyDeepdiff(PythonPackage):
    ...
    version("8.6.1", sha256="ec56d7a769ca80891b5200ec7bd41eec300ced91ebcc7797b41eb2b3f3ff643a")  # FIXME
    version("8.6.0", sha256="6197216c2d777c3106a9989055c230e25848e599b26dcbcdc66226bd8d7fe901")  # FIXME
    ...
    version("8.2.0", sha256="6ec78f65031485735545ffbe7a61e716c3c2d12ca6416886d5e9291fc76c46c3")
    ...
    depends_on("py-flit-core@3.11:3", type="build", when="@8.5:")
    depends_on("py-setuptools", type="build", when="@:8.4")

    depends_on("py-orderly-set@5.4.1:5", when="@8.5.0:", type=("build", "run"))
    depends_on("py-orderly-set@5.3.0:5", when="@8.2.0:", type=("build", "run"))
