...
class Gptune(CMakePackage):
    ...
    depends_on("py-scikit-optimize@0.9.0", patches=[patch("space.patch")], type=("build", "run"),when="@:4.0.0")
    depends_on("py-scikit-optimize@0.9.0", patches=[patch("gptunev5-skopt.patch")], type=("build", "run"),when="@5.0.0:")
    ...
    depends_on("py-ytopt-autotune@1.1.0", patches=[patch("gptunev5-autotune.patch")], type=("build", "run"))
