...
class Neovim(CMakePackage):
    ...
    version("0.12.4", sha256="2727da95d2b8b809bc7c71e085452e47dfe1d8aa7cfaa15c68004e23f6f0a6dd")
    version("0.12.3", sha256="36a6c66bfbba5d96fa512110aecddb981148a4d013b5ecd01a42877c49855a41")
    ...
    with default_args(deprecated=True):
        version(
            "0.11.7", sha256="b550b0e4cd2a0f9558bc6b278d27e47b528f7684efa2a46def438fcd64ee9822"
        )
        version(
            "0.11.6", sha256="d1c8e3f484ed1e231fd5f48f53b7345b628e52263d5eef489bb8b73ca8d90fca"
        )
        version(
            "0.11.5", sha256="c63450dfb42bb0115cd5e959f81c77989e1c8fd020d5e3f1e6d897154ce8b771"
        )
        version(
            "0.11.4", sha256="83cf9543bedab8bec8c11cd50ccd9a4bf1570420a914b9a28f83ad100ca6d524"
        )
        version(
            "0.11.3", sha256="7f1ce3cc9fe6c93337e22a4bc16bee71e041218cc9177078bd288c4a435dbef0"
        )
        version(
            "0.11.2", sha256="324759a1bcd1a80b32a7eae1516ee761ec3e566d08284a24c4c7ca59079aabfa"
        )
        version(
            "0.11.1", sha256="ffe7f9a7633ed895ff6adb1039af7516cd6453715c8889ad844b6fa39c3df443"
        )
        version(
            "0.11.0", sha256="6826c4812e96995d29a98586d44fbee7c9b2045485d50d174becd6d5242b3319"
        )
        version(
            "0.10.4", sha256="10413265a915133f8a853dc757571334ada6e4f0aa15f4c4cc8cc48341186ca2"
        )
        version(
            "0.10.3", sha256="39fab47d241da7b9418823cc563c689d522c1c4b2def04036393834f3f1ca94c"
        )
        version(
            "0.10.2", sha256="546cb2da9fffbb7e913261344bbf4cf1622721f6c5a67aa77609e976e78b8e89"
        )
        version(
            "0.10.1", sha256="edce96e79903adfcb3c41e9a8238511946325ea9568fde177a70a614501af689"
        )
        version(
    ...
    depends_on("gettext")
    depends_on("gperf", type="build", when="@:0.7")
    depends_on("lua-lpeg")
    depends_on("lua-mpack", when="@:0.9")
    depends_on("iconv", type="link")
    depends_on("libuv@1.28.0:", type="link")
    ...
    with when("@0.6:"):
        ...
        depends_on("gperf@3.1:", type="build", when="@:0.7")
