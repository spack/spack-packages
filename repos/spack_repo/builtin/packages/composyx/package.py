...
class Composyx(CMakePackage):
    ...
    url = "https://gitlab.inria.fr/api/v4/projects/52455/packages/generic/source/v1.4.0/composyx-1.4.0.tar.gz"
    maintainers("fpruvost")

    version("main", branch="main", submodules=True)
    version("1.4.0", sha256="8b8e29b80284c65ca0c18774628ddaeca503e8b0345e295c1f1f823607395818")
