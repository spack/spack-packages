...
class PyUv(PythonPackage):
    ...
    This package has been deprecated in favor of the pure rust uv package.
    The packages are functionally identical save for a python dependency and
    this package can be safely replaced.
    """
