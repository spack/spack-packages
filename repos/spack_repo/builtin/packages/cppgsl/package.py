...
class Cppgsl(CMakePackage):
    ...
    Deprecated: this package was renamed to ms-gsl, which more clearly
    identifies it as Microsoft's implementation of the Guidelines Support
    Library. Use ms-gsl instead."""
