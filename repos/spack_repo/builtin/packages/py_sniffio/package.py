...
class PySniffio(PythonPackage):
    ...
    version("1.3.1", sha256="f4324edc670a0f49750a81b895f35c3adb843cca46f0530f79fc1babb23789dc")
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@1.3:")
    depends_on("py-setuptools@64:", type="build", when="@1.3.1:")
    depends_on("py-setuptools", type="build", when="@:1.3.0")
    depends_on("py-setuptools-scm@6.4:", type="build", when="@1.3.1:")
