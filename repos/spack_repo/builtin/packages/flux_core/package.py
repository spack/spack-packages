...
class FluxCore(AutotoolsPackage):
    ...
    version("0.83.1", sha256="f46afb0f4cf79ca27314b2a5cb8fd90172ecee710f10a07ea6c008a12d806541")
    version("0.83.0", sha256="1a1c545add508a895d738b401cba1e3f6e22318a05f0e2df0a23d00b14b2e66b")
    version("0.82.0", sha256="26c4a324dd93a2cc395f158d5ddc44231dd256e9d9684b6fbc9838d5cd06ab65")
    ...
    depends_on("jansson@2.8:")
    depends_on("jansson@2.11:", when="@0.78.0:")
    ...
    depends_on("flux-security@0.9.0:", when="@0.52.0: +security")
    depends_on("flux-security@0.13.0:", when="@0.68.0: +security")
