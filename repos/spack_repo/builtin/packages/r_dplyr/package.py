...
class RDplyr(RPackage):
    ...
    version("1.2.0", sha256="a82c292f2249d439157986b504edd1d99741f467c75bf08969254ca8d441bfa3")
    ...
    depends_on("r-lifecycle@1.0.5:", type=("build", "run"), when="@1.2.0:")
    ...
    depends_on("r-rlang@1.1.7:", type=("build", "run"), when="@1.2.0:")
    ...
    depends_on("r-vctrs@0.7.1:", type=("build", "run"), when="@1.2.0:")
    ...
    depends_on("r-bh@:1.77", type=("build", "run"), when="@:0.7")  # 1.75 works, 1.78 doesn't
