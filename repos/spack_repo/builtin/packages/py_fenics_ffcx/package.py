...
class PyFenicsFfcx(PythonPackage):
    ...
    version("0.10.1", sha256="316a6356125b8fae1bf6ffb62c6690381df94e1723bc1aa73bcba0a7b062d0ed")
    ...
    depends_on("py-setuptools@77:", when="@0.10:", type="build")
    ...
    depends_on("py-fenics-ufl@2025.2.0:", type=("build", "run"), when="@0.10")
