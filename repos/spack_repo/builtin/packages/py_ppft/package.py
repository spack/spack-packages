...
class PyPpft(PythonPackage):
    ...
    with default_args(type="build"):
        depends_on("py-setuptools@0.42:", when="@1.7.6.5:")
        depends_on("py-setuptools@0.6:")

    with default_args(type=("build", "run")):
        depends_on("python@3.9:", when="@1.7.7:")
        depends_on("python@3.8:", when="@1.7.6.8:")
        depends_on("python@3.7:", when="@1.7.6.6:")
        depends_on("python@2.7:2.8,3.7:", when="@1.7.6.5")
        depends_on("python@2.7:2.8,3.6:", when="@1.6.6.4")
        depends_on("python@2.5:2.8,3.1:", when="@:1.6.6.1")

        depends_on("py-dill@0.4.1:", when="@1.7.8")
        depends_on("py-dill@0.3.9:", when="@1.7.6.9")
        depends_on("py-dill@0.3.8:", when="@1.7.6.8")
        depends_on("py-dill@0.3.7:", when="@1.7.6.7")
        depends_on("py-dill@0.3.6:", when="@1.7.6.6")
        depends_on("py-dill@0.3.5:", when="@1.7.6.5")
        depends_on("py-dill@0.3.4:", when="@1.6.6.4:")
        depends_on("py-dill@0.2.6:")

        # Historical dependencies
        depends_on("py-six@1.7.3:", when="@:1.7.6.5")
