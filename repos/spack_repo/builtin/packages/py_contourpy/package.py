...
class PyContourpy(PythonPackage):
    ...
    version("1.3.3", sha256="083e12155b210502d0bca491432bb04d56dc3432f95a979b429f2848c3dbe880")
    ...
    with default_args(type="build"):
        depends_on("meson@1.2:", when="@1.1.1:")
        depends_on("py-meson-python@0.13.1:", when="@1.1:")
        with default_args(type=("build", "link")):
            depends_on("py-pybind11@2.13.2:", when="@1.3.1:")
