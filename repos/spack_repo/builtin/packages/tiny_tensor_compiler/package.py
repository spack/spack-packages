...
class TinyTensorCompiler(CMakePackage):
    ...
    url = "https://github.com/intel/tiny-tensor-compiler/archive/refs/tags/v0.4.0.tar.gz"
    ...
    depends_on("double-batched-fft-library ~sycl ~level_zero ~opencl@0.5.1:", type="link", when="@:0.3.1")
