...
class PyDistributed(PythonPackage):
    ...
    depends_on("python@3.10:", when="@2024.8.1:", type=("build", "run"))
    ...
    depends_on("py-cloudpickle@3.0.0:", type=("build", "run"), when="@2024.8.2:")
    ...
    depends_on("py-msgpack@1.0.2:", type=("build", "run"), when="@2024.8.1:")
    ...
    depends_on("py-psutil@5.8.0:", type=("build", "run"), when="@2024.8.1:")
    ...
    depends_on("py-pyyaml@5.4.1:", type=("build", "run"), when="@2024.8.1:")
