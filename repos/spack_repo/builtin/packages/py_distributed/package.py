...
class PyDistributed(PythonPackage):
    ...
    depends_on("python@3.10:", when="@2025.7.0:", type=("build", "run"))
    ...
    depends_on("py-msgpack@1.0.2:", type=("build", "run"), when="@2025.7.0:")
    ...
    depends_on("py-psutil@5.8.0:", type=("build", "run"), when="@2025.7.0:")
    ...
    depends_on("py-toolz@0.11.2:", type=("build", "run"), when="@2025.7.0:")

    depends_on("py-tornado@6.2.0:", type=("build", "run"), when="@2025.7.0:")
    ...
    depends_on("py-pyyaml@5.4.1:", type=("build", "run"), when="@2025.7.0:")
    depends_on("py-pyyaml@5.3.1:", type=("build", "run"), when="@2023.4.1:")
    depends_on("py-pyyaml", type=("build", "run"))

    depends_on("py-urllib3@1.26.5:", type=("build", "run"), when="@2025.7.0:")
