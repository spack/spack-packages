...
class PyPytest(PythonPackage):
    ...
    # to unit test Spack itself. Spack supports installing Python 3.10+, but also needs to support
    # running Python 3.6+.
    ...
    # These versions suffer from a security vulnerability and are obsolete anyway, remove at
    ...
    with default_args(type="build"):
        depends_on("py-setuptools@77:", when="@9:")
        depends_on("py-setuptools@61:", when="@8.1:")
        depends_on("py-setuptools@45:", when="@7:")
        depends_on("py-setuptools@42:", when="@6.2:")
        depends_on("py-setuptools@40:", when="@3.9.2:")
        depends_on("py-setuptools@30.3:", when="@3.9.0:")
