...
class PyDuecredit(PythonPackage):
    ...
    depends_on("python@3.8:", type="build", when="@0.10:")
    depends_on("py-setuptools", type="build")

    depends_on("py-citeproc-py@0.4:", type=("build", "run"))
    depends_on("py-looseversion", type=("build", "run"), when="@0.10:")
    depends_on("py-packaging", type=("build", "run"), when="@0.10:")
    depends_on("py-requests", type=("build", "run"))

    # Historical dependencies
    depends_on("py-six", type=("build", "run"), when="@:0.92")
    depends_on("py-importlib-metadata", type=("build", "run"), when="@0.9 ^python@:3.7")
