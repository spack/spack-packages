...
class PyPydot(PythonPackage):
    ...
    version("4.0.1", sha256="c2148f681c4a33e08bf0e26a9e5f8e4099a82e0e2a068098f32ce86577364ad5")
    ...
    depends_on("py-setuptools@75.3.2:", type="build", when="@4.0.1:")
    depends_on("py-setuptools", type="build")
    depends_on("py-pyparsing@3.1:", type=("build", "run"), when="@4.0.1:")
