...
class PyBlack(PythonPackage):
    ...
    with default_args(type="build"):
        depends_on("py-hatch-fancy-pypi-readme", when="@22.10:")
        depends_on("py-hatch-vcs@0.3:", when="@26.3:")
        depends_on("py-hatch-vcs", when="@22.10:")
        depends_on("py-hatchling@1.27:", when="@25.11:")
        depends_on("py-hatchling@1.20:", when="@23.12.1:")
        depends_on("py-hatchling@1.8:", when="@22.10:")

    with default_args(type=("build", "run")):
        depends_on("python@3.10:", when="@25.12:")
        ...
        depends_on("py-pathspec@1.0:", when="@26.1:")
        depends_on("py-pathspec@0.9:")
        depends_on("py-platformdirs@2:")
        depends_on("py-pytokens@0.4", when="@26:")
