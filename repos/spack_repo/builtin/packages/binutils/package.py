...
class Binutils(AutotoolsPackage, GNUMirrorPackage):
    ...
    version("2.47", sha256="3068128c75cda9f898ccb4211d360246e8e195ffcc9dfb655b23ae23a54800e8")
    ...
    def flag_handler(self, name, flags):
        ...
        if name == "cxxflags" and (
            spec.satisfies("@:2.31.1") and self.spec.compiler.name in ("fj", "clang", "apple-clang")
        ):
