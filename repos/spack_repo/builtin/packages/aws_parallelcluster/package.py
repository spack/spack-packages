...
class AwsParallelcluster(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-boto3@1.16.14:", when="@2.10:")
        depends_on("py-boto3@1.14.3:", when="@2.8:")
        depends_on("py-boto3@1.10.15:")
        depends_on("py-tabulate@0.8.8:0.8.10", when="@2.11.8:")
        depends_on("py-tabulate@0.8.2:0.8.9", when="@2.11.0:2.11.7")
        depends_on("py-tabulate@0.8.2:0.8.7", when="@2.9:2.10")
        depends_on("py-tabulate@0.8.2:0.8.3", when="@:2.8")
        depends_on("py-ipaddress@1.0.22:")
        depends_on("py-pyyaml@5.3.1:", when="@2.9:")
        depends_on("py-pyyaml@5.1.2:")
        depends_on("py-jinja2@2.11:", when="@2.9:")

        # Historical dependencies
        depends_on("py-future@0.16:0.18.2", when="@:2.10")
