...
class Gcc(AutotoolsPackage, GNUMirrorPackage, CompilerPackage):
    ...
    # Severity >= any vuln in the range, so severity filters never favor older releases
    deprecated("@:13", reason="retired", severity="high")
    deprecated("@14.1.0,14.3.0", reason="retired")
    deprecated("@7.1:12.3,13.1:13.2", reason="vuln", severity="high", labels=["CVE-2026-95619"])
