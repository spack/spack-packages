...
class PyRioxarray(PythonPackage):
    ...
    variant("interp", default=False, when="@0.17:", description="Enable interpolation routines")

    depends_on("py-setuptools", type="build")

    with default_args(type=("build", "run")):
        depends_on("python@3.10:", when="@0.17:")
        depends_on("py-packaging", when="@0.17:")
        depends_on("py-rasterio@1.4.3:", when="@0.19:")
        depends_on("py-rasterio@1.3:", when="@0.17:")
        depends_on("py-rasterio")
        depends_on("py-xarray@2024.7:", when="@0.19:")
        depends_on("py-xarray@2022.3:", when="@0.17:")
