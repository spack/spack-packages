...
class PyMetatrain(PythonPackage):
    ...
    version("2026.3.1", sha256="29337ce20b133a074b9873dabe9b70d35ceb639ef2382bafb42c825856a52860")
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-metatensor-learn@0.4.0:0.4", when="@2025.12:2026.2")
        depends_on("py-metatensor-learn@0.5.0:0.5", when="@2026.3.1:")
        depends_on("py-metatensor-operations@0.3.4:0.3", when="@2025.11")
        depends_on("py-metatensor-operations@0.4.0:0.4", when="@2025.12:2026.2")
        depends_on("py-metatensor-operations@0.5.0:0.5", when="@2026.3.1:")
        depends_on("py-metatensor-torch@0.8.1:0.8", when="@2025.11")
        depends_on("py-metatensor-torch@0.8.2:0.8", when="@2025.12:2026.2")
        depends_on("py-metatensor-torch@0.10.0:0.11", when="@2023.3.1:")
        ...
        depends_on("py-metatomic-torch@0.1.15:0.1", when="@2026.3:")
