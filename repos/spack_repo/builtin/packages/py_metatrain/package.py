...
class PyMetatrain(PythonPackage):
    ...
    depends_on("py-metatensor-torch@0.7.6:0.7", type=("build", "run"), when="@2025.10:")
    depends_on("py-metatensor-torch@0.8.1:0.8", type=("build", "run"), when="@2025.11:")
    depends_on("py-metatomic-torch@0.1.2:0.1", type=("build", "run"), when="@2025.10:")
    depends_on("py-metatomic-torch@0.1.5:0.1", type=("build", "run"), when="@2025.11:")
